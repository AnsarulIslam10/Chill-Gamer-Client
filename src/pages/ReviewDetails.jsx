...
const ReviewDetails = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-2 mb-16 mt-16">
      <Helmet>
        <title>Chill Gamer | Review Details</title>
      </Helmet>
      <div className="grid md:grid-cols-12 items-center max-w-5xl mx-auto justify-center md:gap-8 dark:bg-slate-800 p-6 sm:p-8 md:p-12 shadow-lg rounded-xl">
