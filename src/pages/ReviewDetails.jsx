...
const ReviewDetails = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-2 mb-32 mt-32">
      ...
      <div>
        <h2 className="text-3xl mb-1 font-semibold"><span></span>{name}</h2>
        <p className="btn btn-xs btn-ghost btn-outline border-green-600 rounded-full text-green-600 mb-2">{genres}</p>
        <p><span className="font-semibold mb-2">Release Year: </span>{year}</p>
        <p><span className="font-semibold">Review: </span><span className="italic text-purple-700 dark:text-purple-400">"{description}"</span></p>
        ...
        <div>
            <button onClick={handleAddToWatchlist} className="btn bg-purple-500 border-none rounded-none text-white">
